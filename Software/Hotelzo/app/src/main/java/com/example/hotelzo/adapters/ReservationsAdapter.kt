...
class ReservationsAdapter(private val reservationList: ArrayList<Reservations>,  private val activity: AllReservationsActivity) : RecyclerView.Adapter<ReservationsAdapter.reservationViewHolder>() {
